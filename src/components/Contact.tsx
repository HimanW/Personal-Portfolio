            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4>Email</h4>
                    <p className="text-muted-foreground">himanhansadh.withana@gmail.com</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4>Phone</h4>
                    <p className="text-muted-foreground">+94 (76) 759 9838</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h4>Location</h4>
                    <p className="text-muted-foreground">Melford Crescent, Dehiwala, Sri Lanka</p>
