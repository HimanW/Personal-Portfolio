      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left order-2 lg:order-1">
            {/* Status Badge */}
            <div className="flex justify-center lg:justify-start opacity-0">
              <Badge
                variant="secondary"
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <p className="text-xl sm:text-2xl text-muted-foreground max-w-lg">
                  AI/ML Engineer & Applied Researcher crafting intelligent systems
                  <span className="text-primary"> 2+ years</span> of expertise
                </p>
                
                <p className="text-lg text-muted-foreground/80 max-w-md">
                  Strong background in full-stack development and MLOps for production-ready AI systems
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-4 justify-center lg:justify-start">
              ...
              >
                <a href="https://github.com/HimanW" target="_blank" rel="noopener noreferrer">
              ...
              <Button 
                ...
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
              >
                <a href="https://linkedin.com/in/himan-withana" target="_blank" rel="noopener noreferrer">
              ...
              <Button 
                ...
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
              >
                <a href="https://x.com/d1v3xx" target="_blank" rel="noopener noreferrer">
              ...
              <Button
                ...
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
              >
                <a href="https://www.instagram.com/d1v3__" target="_blank" rel="noopener noreferrer">
              ...
              <Button
                ...
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
              >
                <a href="https://www.facebook.com/d1v3x" target="_blank" rel="noopener noreferrer">
              ...
              <Button
                ...
                className="h-12 w-12 rounded-full bg-background/50 backdrop-blur-sm border border-primary/10 hover:bg-primary/10 hover:border-primary/30 transition-all duration-300"
              >
                <a href="mailto:himanhansadh.withana@gmail.com" target="_blank" rel="noopener noreferrer">
